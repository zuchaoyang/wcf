<?php
/////////////////////////////////////////////////////////////////////////////
// 这个文件是 指云时代网站论坛 项目的一部分
//
// Copyright (c) 2008 - 2010 www.sensky.com
//
// 要查看完整的版权信息和许可信息，请查看源代码中附带的 COPYRIGHT 文件，
// 或者访问 http://www.sensky.com/ 获得详细信息。
/////////////////////////////////////////////////////////////////////////////

/**
 * FILE_NAME : fileType.php   FILE_PATH : \forum\classes\libraries\fileType.php
 * ....文件类型
 *
 * @copyright Copyright (c) 2008 - 2010 www.sensky.com
 * @author javie jvsys999@hotmail.com
 * @package 
 * @subpackage 
 * @version Sun Apr 20 11:22:37 CST 2008
 */

$filetype = array( );
$filetype['hqx'] = "application/mac-binhex40";
$filetype['bin'] = "application/octet-stream";
$filetype['sis'] = "application/octet-stream";
$filetype['nth'] = "application/x-zip-compressed";
$filetype['sisx'] = "application/octet-stream";
$filetype['mtf'] = "application/octet-stream";
$filetype['thm'] = array("application/octet-stream","application/vnd.eri.thm");
$filetype['utz'] = array("application/x-zip-compressed","application/vnd.uiq.thm");
$filetype['cab'] = "application/octet-stream";
$filetype['tsk'] = "application/octet-stream";
$filetype['hme'] = "application/octet-stream";
...
$filetype['xlsx'] = array("application/octet-stream", "application/x-zip-compressed");
